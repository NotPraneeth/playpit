...
export const aileron = localFont({
    src: [
        ...
        { path: '../fonts/Aileron-BoldItalic.woff2', weight: 'bold', style: 'italic' },
        ...
        { path: '../fonts/Aileron-Italic.woff2', weight: 'normal', style: 'italic' },
        ...
        { path: '../fonts/Aileron-Bold.woff2', weight: 'bold', style: 'normal' },
        { path: '../fonts/Aileron-Light.woff2', weight: '300', style: 'normal' },
        { path: '../fonts/Aileron-Regular.woff2', weight: 'normal', style: 'normal' },
